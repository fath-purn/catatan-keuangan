...
export default function EditGoals() {
  ...
  return (
    <div className="min-h-full bg-[#FDF8EE] flex flex-col relative font-sans text-black">
      ...
      <div className={`px-5 pt-8 pb-6 border-b-4 border-black shadow-[0_4px_0_0_#000] sticky top-0 z-20 transition-colors duration-300`} style={{ backgroundColor: warna }}>
