      ...
      <div className="max-w-5xl mx-auto w-full px-4 md:px-8 mt-8 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        ...
        <div className="bg-[#E4F087] border-2 border-black rounded-3xl p-5 shadow-[4px_4px_0_0_#000] flex flex-col transition-transform active:scale-95">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-sm font-bold text-black uppercase tracking-tight">{t.total_saldo}</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-[#60D689] border-2 border-black rounded-3xl p-4 shadow-[4px_4px_0_0_#000] flex flex-col justify-center transition-transform active:scale-95">
            <h2 className="text-black text-[10px] font-bold uppercase mb-1 bg-white/50 w-fit px-2 py-0.5 rounded-full border border-black shadow-[1px_1px_0_0_#000]">{t.pemasukan}</h2>
          ...
          <div className="bg-[#FF7676] border-2 border-black rounded-3xl p-4 shadow-[4px_4px_0_0_#000] flex flex-col justify-center transition-transform active:scale-95">
            <h2 className="text-black text-[10px] font-bold uppercase mb-1 bg-white/50 w-fit px-2 py-0.5 rounded-full border border-black shadow-[1px_1px_0_0_#000]">{t.pengeluaran}</h2>
        ...
        {data.goals ? (
          <Link href="/goals" className="bg-[#DBCBFF] border-2 border-black rounded-3xl p-5 shadow-[4px_4px_0_0_#000]">
            <div className="flex justify-between items-center mb-4">
              <div className="flex justify-center items-center gap-2">
                ...
                <h2 className="font-black text-sm uppercase">{t.goals_kamu}</h2>
              </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between text-xs font-bold text-black/80">
                <span>{t.terkumpul}: {data.goals.terkumpul}</span>
                <span>{t.target}: {data.goals.target}</span>
              </div>
          ...
          <div className="bg-[#DBCBFF] border-2 border-black rounded-3xl p-5 shadow-[4px_4px_0_0_#000] flex flex-col items-center justify-center text-center gap-2">
            ...
            <h2 className="font-black text-sm uppercase">{t.belum_ada_goals}</h2>
            <p className="text-xs font-bold text-black/60">{t.yuk_buat_goals}</p>
        ...
        <div className="bg-white border-2 border-black rounded-3xl p-5 shadow-[4px_4px_0_0_#000] mb-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-black text-sm uppercase">{t.transaksi_terakhir}</h2>
