...
const data = [
  {
    periode: "Mei 2026",
    totalPengeluaran: 3100000,
    kategori: [
      { id: "Makanan", total: 1200000 },
      { id: "Belanja", total: 800000 },
      { id: "Transportasi", total: 500000 },
      { id: "Tagihan", total: 400000 },
      { id: "Lainnya", total: 200000 },
    ]
  },
  {
    periode: "April 2026",
...
export default function LaporanPengeluaran() {
  ...
  const maxKategori = Math.max(...currentMonthData.kategori.map(k => k.total));
  ...
  const pieGradientStops = currentMonthData.kategori.map((kat, index) => {
