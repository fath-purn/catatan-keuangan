...
export default function TambahTransaksi() {
  ...
  return (
    <div className="min-h-full bg-[#FDF8EE] flex flex-col relative font-sans text-black">
      ...
      <div className="bg-[#DBCBFF] px-5 pt-8 pb-6 border-b-4 border-black shadow-[0_4px_0_0_#000] sticky top-0 z-20">
        <div className="max-w-5xl mx-auto w-full flex items-center justify-between">
          ...
          <h1 className="text-xl font-black text-black uppercase">{t("tambah_transaksi")}</h1>
          <div className="w-10"></div>
        </div>
      </div>

      <form action={formAction} className="max-w-xl mx-auto w-full flex-1 flex flex-col pb-10">
